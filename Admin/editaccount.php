	...
	<!--dito lalagay mga input--->
	 ...
	 <section class="content">
          <div class="row">
			...
			$id = $_GET['admin_id'];
				$result = mysql_query("SELECT * FROM `tbl_admin_id` WHERE admin_id = '$id'");
				while($rs=mysql_fetch_array($result)) {
              echo '<form action="editaccount-exec.php?admin_id='.$rs['admin_id'].'" method="post">';
                   echo  '<div class="box-body">';
                     echo  '<div class="form-group">';
                       echo  '<label for="">ID Number</label>';
                       echo  '<input type="text" class="form-control" name="id"  value='.$rs['admin_id'].' readonly>';
                     echo  '</div>';
                     echo  '<div class="form-group">';
                      echo  ' <label for="">Username</label>';
                      echo  ' <input type="text" class="form-control" name="username" value='.$rs['username'].'>';
                    echo  ' </div>';
                     echo  '<div class="form-group">';
                      echo  ' <label for="">Password</label>';
                      echo  ' <input type="text" class="form-control" name="password" value='.$rs['password'].'>';
                    echo  ' </div>';
                     echo  ' <div class="form-group">';
                     echo  '  <label for="">Firstname</label>';
                     echo  '  <input type="text" class="form-control" name="firstname" value='.$rs['firstname'].'>';
                    echo  ' </div>';
					 echo  ' <div class="form-group">';
                      echo  ' <label for="">Lastname</label>';
                    echo  '   <input type="text" class="form-control" name="lastname" value='.$rs['lastname'].'>';
                     echo  '</div>';
                  ...
                  echo  ' </div>';
				   ...
				   echo '&nbsp;&nbsp;';
				   echo '<a href="updateaccounts.php">';
					echo '<button type="button" class="btn btn-danger btn-large" name="cancel">Cancel</button>';
					echo '</a>';
                  echo  ' </div>';
                 echo  '</form>';
				}
