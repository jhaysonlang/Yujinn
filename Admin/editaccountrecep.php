    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $login_session_firstname,$login_session_lastname ; ?></p>
	 ...
	 <section class="content">
          <div class="row">
			...
			$id = $_GET['receptionist_id'];
				$result = mysql_query("SELECT * FROM `tbl_receptionist_id` WHERE receptionist_id = '$id'");
				while($rs=mysql_fetch_array($result)) {
              echo '<form action="editaccountrecep-exec.php?receptionist_id='.$rs['receptionist_id'].'" method="post">';
                   echo  '<div class="box-body">';
                     echo  '<div class="form-group">';
                       echo  '<label for="">ID Number</label>';
                       echo  '<input type="text" class="form-control" name="id"  value='.$rs['receptionist_id'].' readonly>';
                     echo  '</div>';
                     echo  '<div class="form-group">';
