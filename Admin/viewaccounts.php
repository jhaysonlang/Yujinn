    ...
    <section class="sidebar">
	  ...
	  <li class="treeview"> 
		...
		<li class="active"> 
          ...
          <ul class="treeview-menu">
				<li class="active"><a href="viewaccounts.php"><i class="fa fa-user"></i> <span>View Accounts</span></a></li>
...
<li><a href="pendingreservation.php"><i class="fa fa-hourglass-1"></i> <span>Pending Status</span></a></li>	  		
  ...
  <div class="content-wrapper">
          ...
          <div class="box">
			...
			<center>
              <h3 class="box-title"><b>View Accounts</b></h3>
				</center>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				while($rs=mysql_fetch_array($result)) {
					$i = 1;
					if ($rs['status'] == 'Active') {
							$accountstatus = "<span class='label label-success'>".$rs['status']."</span>";
						}
						else if ($rs['status'] == 'Disable') {
							$accountstatus = "<span class='label label-warning'>".$rs['status']."</span>";
						}
						echo "<tr>";
