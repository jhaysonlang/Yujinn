                        ...
                        <div class="navbar-inner">
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav pull-right">
                                    ...
                                    <li >
                                        <a href="rates.php"><i class="icon-camera"></i><br />Room & Rates</a>
                                    </li>
          ...
          <div class="span6 offset3">
            ...
            <div class="widget-b">
              <div class="center-alignment">
                <form class="form-horizontal form-signin-signup" method="post" action="guestlogin.php">
                  <input type="text" name="emailaddress" placeholder="E-mail Address">
                  <input type="password" name="rcode" placeholder="Booking ID #" onkeypress="return isNumber(event)">
