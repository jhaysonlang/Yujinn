...
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
  ...
  <script>
		...
		window.location.href='reservation3.php?checkin=<?php echo $_GET['checkin']?>&checkout=<?php echo $_GET['checkout']?>&arrivaltime=<?php echo $_GET['arrivaltime']?>&nights=<?php echo $_GET['nights']?>&number1=<?php echo $_GET['number1']?>&number2=<?php echo $_GET['number2']?>&number3=<?php echo $_GET['number3']?>&number4=<?php echo $_GET['number4']?>';
	
	</script>
	<?php
}

else if ($_GET['emailaddress'] != $_GET['confirmemail'])  {
	?>
	<script>
                        ...
                        <div class="navbar-inner">
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav pull-right">
                                    ...
                                    <li >
                                       <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-camera"></i><br />Room & Rates</a>
                                    </li>
...
echo '</div>';
		...
		?>
			  ...
			  <button type="submit" class="btn btn-large btn-block btn-success">Make Reservation</button>
