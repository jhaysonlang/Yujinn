          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<br><label>Start:&nbsp;</label> <input type="text" name="checkin" id='sd' placeholder="Check-in" value="<?php echo $checkin ?>"required>
					&nbsp;&nbsp;&nbsp;
					<label>End:&nbsp;</label> <input type="text" name="checkout" id='ed' placeholder="Check-out" value="<?php echo $checkout ?>"required><br>
				...
				$getLinks = "SELECT * FROM tbl_dailysales where date='$curDate'";
	...
	<tr>
		...
		<tr>
			...
			<td class="red"><b><?php echo $totalsum?></b></td>
			  ...
			  <br>
         <a href="reports.php"><input type="submit" name="update" value="Print" class="btn btn-primary btn-large"></a>
		 </form>
          </div><!-- /.box-body -->
              </div><!-- /.box -->
