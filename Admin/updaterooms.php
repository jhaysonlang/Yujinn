	  ...
	  <li class="treeview"> 
		...
		<li class="active"> 
          ...
          <ul class="treeview-menu">
				...
				<li class="active"><a href="updaterooms.php"><i class="fa fa-money"></i> <span>Update Rates</span></a></li>
  ...
  <div class="content-wrapper">
          ...
          <div class="box">
            <div class="box-header">
             <center> <h3 class="box-title"><b>Update Rates</b></h3></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		if(isset($_GET['search'])){
			...
			$qry = mysql_query("SELECT * FROM tbl_room where roomnumber like '%$search%' 
					or roomName like '%$search%' or roomrates like '%$search%'or capacity like '%$search%'
   ...
   echo ' <div class="modal-dialog modal-sm">';
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
	  ...
	  echo '<a  href=deleterooms-exec.php?room_id='.$get.'> <input type="submit" name="Delete" value="Yes" class="btn btn-danger btn-large"></a> &nbsp;';
...
location.href = "updaterooms.php?id=" + $('.a').val();
})
})
</script>
