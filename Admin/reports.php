  ...
  <ul class="sidebar-menu">
	  ...
	  <li class="treeview"> 
		...
		<li class="treeview"> 
          ...
          <ul class="treeview-menu">
				<li ><a href="process-exec.php"><i class="fa fa-table"></i> <span>Reservation Table</span></a></li>
   ...
   <div class="content-wrapper">
          ...
          <div class="box">
			...
			<center>
			 <img src="../Yujinn/assets/img/yuj.png" class="yuj">
			 <img src="yujinn1.jpg" class="watermark">
		...
		window.location.href='dailysale.php';
				...
				$getLinks = "SELECT * FROM tbl_dailysales where date BETWEEN '$checkin' AND '$checkout'";
