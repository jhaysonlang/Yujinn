	...
	<input type = "hidden" name = "number3" value = "<?php echo $number3;?>">
		<input type = "hidden" name = "number4" value = "<?php echo $number4;?>">
			   ...
			   <p id="head" class="error"></p>
				...
				<td width="20" class="padding">:</td>
				<td><select class="input-small"" required name="salutation">
					<option value="" ></option>
				...
				<td width="20" class="padding">:</td>
				<td><input class="input-xlarge" id="firstname" type="text" name="firstname" required />
				</td>
				</tr>
				<tr>
				<td width="100" class="padding"><b>Last Name</b></td>
				<td width="20" class="padding">:</td>
				<td><input class="input-xlarge" id='lastname' type="text" name="lastname" required/>
				</td>
				</tr>
				<!--<tr>
				...
				<td width="20" class="padding">:</td>
				<td><input class="input-xlarge" type="text" name="contact" onkeypress="return isNumber(event)" maxlength="11" required/>
				</td>
				</tr>
				...
				<td width="20" class="padding">:</td>
				<td><input class="input-xlarge" type="email" id="email" name="emailaddress" required />
				...
				<td width="20" class="padding">:</td>
				<td><input class="input-xlarge" type="email" id="email" name="confirmemail" required />
				...
				<td width="20" class="padding">:</td>
				<td><textarea class="text" name="address"  rows="7"></textarea></td>
				...
				<table border=0	 height="200" width="30%" class="ref">
				<tr>
				...
				<a href="" class="back">&nbsp;<input type="submit" id="submit" value="Add New Guest" name="save" class="btn btn-primary btn-small"></a>
				</form>
