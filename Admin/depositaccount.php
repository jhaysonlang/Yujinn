...
<li><a href="pendingreservation.php"><i class="fa fa-hourglass-1"></i> <span>Pending Status</span></a></li>			
		<li class="active"><a href="depositaccount.php"><i class="fa fa-credit-card"></i> <span>Deposit Account</span></a></li>
	 ...
	 <section class="content">
          <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Manage Deposit Payment</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                      <div class="box-body">
                     <div class="form-group">
                       <label for="">Name of Bank</label>
						<?php
							...
							$result = mysql_query("SELECT * FROM `tbl_deposit_account` ORDER BY `deposit_id` DESC LIMIT 1");
							while($rs = mysql_fetch_array($result))
							{
							echo '<input type="text" class="form-control" name="bankname" value="'.$rs['bankname'].'" id="bankname" readonly>';
							echo '</div>';
							echo '<div class="form-group">';
							echo '<label for="">Account Number</label>';
							echo '<input type="number" class="form-control" name="accountnumber" value="'.$rs['accountnumber'].'" id="accountnumber" readonly>';
							
							echo '</div>';
							echo '<div class="form-group">';
							echo '<label for="">Account Name</label>';
							echo '<input type="text" class="form-control" name="accountname" value="'.$rs['accountname'].'" id="accountname" readonly>';
                   ...
                   <button type='button' class='btn btn-success btn-sl' data-toggle='modal' data-target='#myModal'>Edit</button>
                   </div>
   ...
   echo ' <div class="modal-dialog modal-sm">';
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
      ...
      echo '    <h4 class="modal-title">Edit Deposit Account</h4>';
      echo '  </div>';
      echo '  <div class="modal-body">';
     
	 echo ' <div class="box-body">';
                     echo ' <div class="form-group">';
                      echo '  <label for="">Name of Bank</label>';
						echo '<form action="manageaccountnumber-exec.php" method="post">';
							
							$result = mysql_query("SELECT * FROM `tbl_deposit_account` ORDER BY `deposit_id` DESC LIMIT 1");
							while($rs = mysql_fetch_array($result))
							{
							echo '<input type="text" class="form-control" name="bankname" value="'.$rs['bankname'].'" id="bankname" required>';
							echo '</div>';
							echo '<div class="form-group">';
							echo '<label for="">Account Number</label>';
							echo '<input type="number" class="form-control" name="accountnumber" value="'.$rs['accountnumber'].'" id="accountnumber" required>';
							echo '</div>';
							echo '<div class="form-group">';
							echo '<label for="">Account Name</label>';
							echo '<input type="text" class="form-control" name="accountname" value="'.$rs['accountname'].'" id="accountname" required>';
							echo '</div>';
							}
	  ...
	  echo '<input type="submit" value="Save" class="btn btn-success btn-large">';
	echo '</form>';
