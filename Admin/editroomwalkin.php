  ...
  <div class="content-wrapper">
          ...
          <div class="box">
            <div class="box-header">
             <center> <h3 class="box-title"><b>Update Rooms Walkin</b></h3></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Room Category</th>
				   <th>Room Offered</th>
				  <td colspan=2 align="center" width="15%"><strong>Operation<strong></td>
                </tr>
                </thead>
                <tbody>
				<tr>
	...
	mysql_select_db('yujinn');
				...
				$getLinks = "SELECT * FROM tbl_room where roomoffered='Walkin'";
				...
				while($rs=mysql_fetch_array($result)) {
					...
					echo "<td>".$rs['roomrates']."</td>";
					echo "<td>".$rs['capacity']."</td>";
					echo "<td>".$rs['category']."</td>";
					echo "<td>".$rs['roomoffered']."</td>";
					echo "<td align='center'><a   href=editrooms.php?room_id=" . $rs['room_id'] . '>' . '<input type="submit" name="update" value="Update" class="btn btn-primary btn-large">' . "</a></td>";
   ...
   echo ' <div class="modal-dialog modal-sm">';
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
      ...
      echo '    <p>Are you sure you want to delete room ?</p>';
	  echo '<a  href=deleterooms-exec.php?room_id='.$roomidget.'> <input type="submit" name="Delete" value="Yes" class="btn btn-danger btn-large"></a> &nbsp;';
