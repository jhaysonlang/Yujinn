...
?>
				<script>
		alert('You cannot modify this reservation anymore because you are already reserve. Thankyou');
...
<center>
        <div class="row">
          <div class="span6 offset3">
		    ...
		    <br><br><img src="assets/img/steps/Step1.png" >
          <br>
		   <br>
		    <br> 
			<?php
             echo  '<form method="get" action="modifyreservation2.php">'
			  ?>
