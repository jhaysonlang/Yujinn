  ...
  <ul class="sidebar-menu">
	    ...
	    <li class="active"> 
          ...
          <ul class="treeview-menu">
            <li ><a href="dailysale.php"><i class="fa fa-money"></i> Daily Sale</a></li>
			 ...
			 <li class="active"><a href="loginreports.php"><i class="fa fa-sign-in" ></i> Log-in Reports</a></li>
   ...
   <div class="content-wrapper">
          ...
          <div class="box">
			...
			<center>
              <h3 class="box-title"><b>Log-in Reports</b></h3>
				</center>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				$getLinks = "SELECT * FROM tbl_login ORDER BY `login_id` DESC";
				...
				while($rs=mysql_fetch_array($result)) {
					...
					echo "<td>".$rs['name']."</td>";
					echo "<td>".$rs['login_date']."</td>";
					echo "<td>".$rs['login_time']."</td>";
					echo "<td>".$rs['logout_time']."</td>";
	...
	?>
        ...
        <br>
         <input onclick="myFunction()" type="submit" name="update" value="Print" class="btn btn-primary btn-large">
          </div><!-- /.box-body -->
              </div><!-- /.box -->
