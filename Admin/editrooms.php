...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="dailysale.php" class="logo">
      ...
      <span class="logo-lg"><b>Yujinn</b></span>
    </a>
	...
	<!--dito lalagay mga input--->
	 ...
	 <section class="content">
          <div class="row">
			...
			$id = $_GET['room_id'];
				$result = mysql_query("SELECT * FROM `tbl_room` WHERE room_id = '$id'");
				while($rs=mysql_fetch_array($result)) {
					$category = $rs['category'];
              echo '<form action="editrooms-exec.php?room_id='.$id.'&category='.$category.'" method="post">';
                   echo  '<div class="box-body">';
                     echo  '<div class="form-group">';
                       echo  '<label for="">Room Name</label>';
                       echo  '<input type="text" class="form-control" name="roomName"  value='.$rs['roomName'].' readonly>';
                     echo  '</div>';
                    echo  '<div class="form-group">';
                     
                      echo  ' <input type="hidden" class="form-control" name="room_id" value='.$rs['room_id'].' readonly>';
                    echo  ' </div>';
					 echo  '<div class="form-group">';
                      echo  ' <label for="">Room Category</label>';
                      echo  ' <input type="text" class="form-control" name="category" value='.$rs['category'].' readonly>';
                    echo  ' </div>';
                     echo  '<div class="form-group">';
                      echo  ' <label for="">Capacity</label>';
                      echo  ' <input type="text" class="form-control" name="capacity" value='.$rs['capacity'].' readonly>';
                    echo  ' </div>';
                     echo  ' <div class="form-group">';
                     echo  '  <label for="">Room Rates</label>';
                     echo  '  <input type="text" class="form-control" name="roomrates" value='.$rs['roomrates'].'>';
                    echo  ' </div>';
                  ...
                  echo  ' </div>';
                   ...
                   echo '<input type="submit" name="update" value="Save" class="btn btn-primary btn-large">';
                  echo  ' </div>';
                 echo  '</form>';
				}
				?>
