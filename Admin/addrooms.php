	   ...
	   <!--Reports-->
		...
		<li class="treeview"> 
          ...
          <ul class="treeview-menu">
				...
				<li class="active"><a href="updaterooms.php"><i class="fa fa-pencil-square-o"></i> <span>Update Rates</span></a></li>
	...
	<!--dito lalagay mga input--->
	 ...
	 <section class="content">
          <div class="row">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="addrooms-exec.php" method="post">
                   <div class="box-body">
                     ...
                     <div class="form-group">
                      ...
                      <select class="form-control" name="roomtype">
							...
							<option>Dorm Type (6 Pax Room)</option>
							<option>Dorm Type (8 Pax Room)</option>
					   </select>
                     </div>
					  <div class="form-group">
                      ...
                      <!--<div class="form-group">
                       ...
                       <input type="text" class="form-control" name="roomrates" placeholder="Room Rates" onkeypress="return isNumber(event)" required>
                     </div>-->
					  <!--<div class="form-group">
                       <label for="">Room Capacity</label>
                       <input type="text" class="form-control" name="capacity"  placeholder="Room Capacity" onkeypress="return isNumber(event)" required>
                     </div>-->
					 <!--<div class="form-group">
                       <label for="">Room Status</label>
                       <input type="text" class="form-control" name="roomstatus"  value="Available" >
                     </div>-->
					 <!--<div class="form-group">
                       <label for="">Room Category</label>
                        <select class="form-control" name="category">
							
							<option>Soloroom</option>
							<option>Doubleroom</option>
							<option>Sixbedroom</option>
							<option>Eightbedroom</option>
					   </select>
                     </div>-->
					 <!--<div class="form-group">
                       <label for="">Room Offered</label>
                        <select class="form-control" name="roomoffered">
...
<!-- ./wrapper -->
   <script>
            ...
            $("#roomtype, #lastname").keypress(function(event){
