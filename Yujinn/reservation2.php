                ...
                <div class="span12">
                    <div class="navbar">
                        <div class="navbar-inner">
                            ...
                            <h1>
                                <a href="" data-toggle='modal' data-target='#myModal' class="brands">Yuj Inn Hostel</a>
                            </h1>
                            <div class="nav-collapse collapse">
                                <ul class="nav pull-right">
                                    <li>
                                        <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-home"></i><br />Home</a>
                                    </li>
                                    <li >
                                       <a href="" data-toggle='modal' data-target='#myModal'><i class=""><img src="beds.png"></i><br />Room & Rates</a>
                                    </li>
                                    
                                    <li class="current-page">
                                       <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-calendar"></i><br />Reservation</a>
                                    </li>
                                    <li>
                                        <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-envelope-alt"></i><br />Contact</a>
                                    </li>
									<li>
                                        <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-user"></i><br />About</a>
                                    </li>
									<li>
                                       <a href="" data-toggle='modal' data-target='#myModal'><i class="icon-signin"></i><br />Log-in</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="span12">
                        ...
                        <h2>Reservation /</h2>
                        <p>Select Your Room Type and Room Preferences</p>
                    </div>
                </div>
            </div>
        </div>
   ...
   echo ' <div class="modal-dialog modal-sm">';
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
	  ...
	  echo '<a  href="index.php"> <input type="submit" name="Delete" value="Yes" class="btn btn-danger btn-sm"></a> &nbsp;';
    ...
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
	  ...
	  echo "<br>";
	    echo "<br>";
		  echo "<br>";
      echo '    <p class="note">Solo Room is with a single bed and a wooden table available for studying. Private rooms are next to shared family style bathrooms. Rooms also have a TV with cable connection.</p>';
    ...
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
	  ...
	  echo "<br>";
	    echo "<br>";
		  echo "<br>";
      echo '    <p class="note">A great place for Romantic Getaways. Room has a double bed. Air conditioning (A/C) in bedroom and an attached bathroom. Rooms also have a TV with cable connection.</p>';
    ...
    echo '  <div class="modal-content">';
     echo '   <div class="modal-header">';
	  ...
	  echo "<br>";
	    echo "<br>";
		  echo "<br>";
      echo '    <p class="note">A spacious dorm room with 4 custom wood bunk beds made for adults. Sleeps up to 8 people with a private bathroom.</p>';
...
echo '</div>';
	...
	<!-- Display Soloroom Row-->
                ...
                <tr>
                  ...
                  <td><?php echo number_format($roomrate,2); ?></td>
                  <td>
      ...
      ?>
			...
			<!-- Display Doubleroom Row-->
                <tr>
                  ...
                  <td><?php echo number_format($roomrate1,2); ?></td>
                  <td>
    ...
    ?>
      ...
      ?>
                ...
                <tr>
                  ...
                  <td><?php echo number_format($roomrate2,2); ?></td>
                  <td>
      ...
      ?>
			...
			<!-- Display Eightbedroom Row-->
                <tr>
                  ...
                  <td><?php echo number_format($roomrate3,2); ?></td>
                  <td>
    ...
    echo '</div>';
			echo '</div>';
			echo '</form>';
			echo '<a href="reservation.php" class="wew"><input type="submit" name="" value="Back" class="btn btn-primary btn-small"></a>';
			?>
